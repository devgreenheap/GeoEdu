...
<div class="card">
  <div class="card-header d-flex align-content-center justify-content-between pb-0 flex-wrap gap-2">
 ...
 <div class="card-body">
    <div class="table-container overflow-auto" id="tableContainer">
      <div id="csvTable">
