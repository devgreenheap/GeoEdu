        ...
        <div class="modal-content">
            ...
            <form id="addCoinPackageForm" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        <label for="coin_amount" class="form-label">{{ __('Star Amount')}}</label>
