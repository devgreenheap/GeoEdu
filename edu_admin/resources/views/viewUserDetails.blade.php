    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center border-bottom">
                ...
                <a data-bs-toggle="modal" data-bs-target="#addCoinsModal" class="btn btn-dark ms-auto">{{ __('Add Stars')}}</a>
            </div>
            <div class="text-center">
                <div class="card-body">
                    <div>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center border-bottom">
                ...
                <a data-bs-toggle="modal" data-bs-target="#addDiamondsModal" class="btn btn-dark ms-auto">{{ __('Add Diamonds')}}</a>
            </div>
            <div class="text-center">
                <div class="card-body">
                    <div>
                        <h1 class="m-0 text-primary">{{GlobalFunction::formatNumber($user->diamond_wallet ?? 0)}}</h1>
                        <span class="fs-6">{{__('Balance')}}</span>
                    </div>
                    <div class="d-flex aligh-items-center justify-content-center mt-3">
                        <div style="width: 120px" class="text-center">
                            <h4 class="m-0 text-primary">{{GlobalFunction::formatNumber($user->diamond_collected_lifetime ?? 0)}}</h4>
                            <span class="fs-6">{{__('Collected')}}*</span>
                        </div>
                        <div style="width: 120px" class="text-center">
                            <h4 class="m-0 text-primary">{{GlobalFunction::formatNumber($user->diamond_spent_lifetime ?? 0)}}</h4>
                            <span class="fs-6">{{__('Spent')}}*</span>
                        </div>
                        <div style="width: 120px" class="text-center">
                            <h4 class="m-0 text-primary">{{GlobalFunction::formatNumber($user->diamond_purchased_lifetime ?? 0)}}</h4>
                            <span class="fs-6">{{__('Purchased')}}*</span>
                        </div>
                    </div>
                    <p class="font-12 mt-2 mb-0">{{__('*lifetime')}}</p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel">{{ __('Add Stars')}}</h4>
            ...
            <form id="addCoinsForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="coins" class="form-label">{{ __('Stars')}}</label>
...
{{-- Add Diamonds Modal --}}
<div id="addDiamondsModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel">{{ __('Add Diamonds')}}</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <form id="addDiamondsForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="diamonds" class="form-label">{{ __('Diamonds')}}</label>
