$(document).ready(function () {
    ...
    const $firstTab = $(".gift-details-tab.active");
    if ($firstTab.length) {
        loadTabFrame($firstTab);
    }

    $(".gift-details-tab").on("shown.bs.tab", function () {
        loadTabFrame($(this));
    });
});
