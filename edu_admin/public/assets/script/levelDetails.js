$(document).ready(function () {
    ...
    const $firstTab = $(".level-details-tab.active");
    if ($firstTab.length) {
        loadTabFrame($firstTab);
    }

    $(".level-details-tab").on("shown.bs.tab", function () {
        loadTabFrame($(this));
    });
});
