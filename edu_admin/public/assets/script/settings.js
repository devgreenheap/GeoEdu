$(document).ready(function () {
    ...
    $("#addDeepARFilterForm").on("submit", function (e) {
        e.preventDefault();
            checkUserType(() => {
                var addTitle = $.trim($("#addDeepARFilterForm [name='title']").val() || "");
                $("#addDeepARFilterForm [name='title']").val(addTitle);
                if (!addTitle) {
    ...
    $("#editDeepARFilterForm").on("submit", function (e) {
        e.preventDefault();
            checkUserType(() => {
                var editTitle = $.trim($("#editDeepARFilterTitle").val() || "");
                $("#editDeepARFilterTitle").val(editTitle);
                if (!editTitle) {
                    showErrorToast("Title is required");
                    return;
                }
    ...
    $("#addOnBoardingScreenForm").on("submit", function (e) {
        e.preventDefault();
            checkUserType(() => {
                var addTitle = $.trim($("#addOnBoardingScreenForm [name='title']").val() || "");
                var addDescription = $.trim($("#addOnBoardingScreenForm [name='description']").val() || "");
                $("#addOnBoardingScreenForm [name='title']").val(addTitle);
                $("#addOnBoardingScreenForm [name='description']").val(addDescription);
                if (!addTitle) {
                    showErrorToast("Title is required");
                    return;
                }
    ...
    $("#editOnBoardingScreenForm").on("submit", function (e) {
        e.preventDefault();
            checkUserType(() => {
                var editTitle = $.trim($("#editOnboardingTitle").val() || "");
                var editDescription = $.trim($("#editOnboardingDesc").val() || "");
                $("#editOnboardingTitle").val(editTitle);
                $("#editOnboardingDesc").val(editDescription);
                if (!editTitle) {
                    showErrorToast("Title is required");
                    return;
                }
