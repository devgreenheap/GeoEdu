...
final class Constants
{
    ...
    const roleRequestPending = 0;
    const roleRequestAccepted = 1;
    const roleRequestRejected = 2;
    const roleRequestHost = 1;
    const roleRequestAgent = 2;
    ...
    const notify_host_request_agent = 9;

    const userDummy = 1;
    const userReal = 0;

    const userPublicFields= 'id,username,fullname,bio,profile_photo,is_verify,device,device_token,app_language,notify_post_like,notify_post_comment,notify_follow,notify_mention,notify_gift_received,notify_chat,coin_collected_lifetime,coin_wallet,diamond_wallet,agent_commission_wallet,diamond_collected_lifetime,diamond_spent_lifetime,diamond_purchased_lifetime,total_post_likes_count,following_count,follower_count,receive_message,is_host,is_agent,agent_id,level_id';
