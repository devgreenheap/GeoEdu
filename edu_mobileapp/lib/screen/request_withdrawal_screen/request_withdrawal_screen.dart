...
import 'package:geoedu/common/widget/custom_drop_down.dart';
...
import 'package:geoedu/screen/request_withdrawal_screen/request_withdrawal_screen_controller.dart';
    ...
    return Scaffold(
        body: Stack(
          children: [
            ...
            Column(
                  children: [
            CustomAppBar(title: LKey.requestWithdrawal.tr,iconColor: Colors.white,),
            Expanded(
              ...
              child: Column(
                ...
                children: [
                            ...
                            children: [
                                  ...
                                  Obx(
                                    () => Text(
                                      ...
                                      style: TextStyleCustom.outFitExtraBold800(
                                          color: whitePure(context), fontSize: 28),
                                    ),
                                  ),
                              ...
                              Text(AppRes.equal,
                                  style: TextStyleCustom.outFitSemiBold600(
                                      color: whitePure(context), fontSize: 26)),
                              Column(
                                children: [
                                  Text(
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 30.0, bottom: 5, right: 20),
                  ...
                  Obx(() {
                    ...
                    return Container(
                      ...
                      child: CustomDropDownBtn<String>(
                          ...
                          bgColor: bgLightGrey(context).withValues(alpha: .1),
