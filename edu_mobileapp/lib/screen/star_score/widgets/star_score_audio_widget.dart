...
class StarScoreAudioWidget extends StatefulWidget {
  const StarScoreAudioWidget({super.key});

  @override
  State<StarScoreAudioWidget> createState() => _StarScoreAudioWidgetState();
}

class _StarScoreAudioWidgetState extends State<StarScoreAudioWidget> {
