...
class StarScoreChatWidget extends StatefulWidget {
  const StarScoreChatWidget({super.key});

  @override
  State<StarScoreChatWidget> createState() => _StarScoreChatWidgetState();
}

class _StarScoreChatWidgetState extends State<StarScoreChatWidget> {
