...
class StarScoreVideoWidget extends StatefulWidget {
  const StarScoreVideoWidget({super.key});

  @override
  State<StarScoreVideoWidget> createState() => _StarScoreVideoWidgetState();
}

class _StarScoreVideoWidgetState extends State<StarScoreVideoWidget> {
