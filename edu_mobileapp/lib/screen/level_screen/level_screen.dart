            ...
            children: [
              Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(colors: [Color(0xff8B1BAE), Color(0xff410D51)],)
                ),
                        ...
                        Row(
                          ...
                          children: [
                            InkWell(
                             ...
                             InkWell(
                                onTap: () {
                                  Get.to(()=>LevelScreenNew());
                                },
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 20.0, right: 20.0, top: 10),
                                  child: Icon(Icons.navigate_next, color: whitePure(context)),
                                ),
                              ),
                          ],
                        ),
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    print("${userLevels?.level} ----- ss  ${levels[index].level}");
                    return Container(
                      margin:
