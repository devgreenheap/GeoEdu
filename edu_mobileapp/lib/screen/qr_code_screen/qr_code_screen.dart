...
import 'package:geoedu/screen/qr_code_screen/qr_code_screen_controller.dart';
import 'package:geoedu/screen/share_sheet_widget/share_sheet_widget.dart';
import 'package:geoedu/utilities/asset_res.dart';
import 'package:geoedu/utilities/color_res.dart';
import 'package:geoedu/utilities/text_style_custom.dart';
import 'package:geoedu/utilities/theme_res.dart';

/// GIO EDU brand gradient (orange -> gold) for the QR frame border.
const _kQrBorderGradient = LinearGradient(
...
class QrCodeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        children: [
          CustomAppBar(title: LKey.myQrCode.tr,iconColor: Colors.white,),
