    ...
    return Container(
      decoration: ShapeDecoration(
        gradient: const LinearGradient(
          colors: [ColorRes.surfaceBackground, ColorRes.cardBackground],
        ),
        shape: SmoothRectangleBorder(
            borderRadius: SmoothBorderRadius(cornerRadius: 10),
            side: BorderSide(color: borderColor ?? bgGrey(context),width: 0.5)),
      ),
      ...
      child: Column(
        ...
        children: [
          Text(
              ...
              style: TextStyleCustom.outFitLight300(
                  fontSize: 14, color: Colors.white).copyWith(fontWeight: FontWeight.bold),
