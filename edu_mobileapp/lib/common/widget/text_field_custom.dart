...
import 'package:geoedu/screen/edit_profile_screen/widget/phone_codes_screen.dart';
...
class _TextFieldCustomState extends State<TextFieldCustom> {
  ...
  Widget build(BuildContext context) {
    final textField = TextField(
      ...
      decoration: InputDecoration(
          ...
          hintStyle: TextStyleCustom.outFitLight300(
              color: widget.transperant ? whitePure(context) : textLightGrey(context), fontSize: 17),
    ...
    final field = widget.gradientBorder
        ? Padding(
            padding: const EdgeInsets.only(top: 8, bottom: 12),
            child: GradientPillBorder(
              height: widget.height ?? 54,
              isActive: !widget.isError,
              child: textField,
            ),
          )
        : Container(
            ...
            decoration: BoxDecoration(
                color: widget.isError
                    ...
                    : widget.transperant ? bgLightGrey(context).withOpacity(.2) : bgLightGrey(context),
