class LKey {
  ...
  static const String coinsYouHave = "Stars You Have";
  static const String coins = "Stars";
  static const String coin = "Star";
  ...
  static const String gatherMoreCoins =
      "Gather more stars, ascend to new heights, and proudly showcase your badge on your profile for all to admire.";
  ...
  static const String coinWallet = "Star Wallet";
  ...
  static const String coinShop = "Star Shop";
  ...
  static const String totalCoinsCollected = "Total Stars Collected";
  ...
  static const String youAreSendingCoinsTo =
      "You are sending stars to @color Participant";
  ...
  static const String youCanNotEnterMoreThanEtc =
      "You cannot enter more than @coin stars!";
  ...
  static const String sendingCoinsMessage =
      "You are sending stars to the above user.";
  ...
  static const String redeemMinCoinDescription =
      "You need to reach the minimum star amount before you can redeem.";
  ...
  static const String registrationBonusDescription =
      "You've earned your registration bonus! Enjoy your stars and start exploring now!";
